...
require import Array4 Array5 Array6 Array8 Array16 Array24 Array25 Array32
               Array33 Array34 Array64 Array96 Array128 Array136 Array168
               Array256 Array400 Array768 Array960 Array1088 Array2304.
require import WArray6 WArray16 WArray32 WArray33 WArray34 WArray40 WArray64
               WArray96 WArray128 WArray136 WArray168 WArray192 WArray200
               WArray256 WArray512 WArray768 WArray800 WArray960 WArray1088
               WArray1536 WArray4608.

abbrev xWING_LABEL = Array6.of_list witness [W8.of_int 92; W8.of_int 46;
W8.of_int 47; W8.of_int 47; W8.of_int 94; W8.of_int 92].
...
module M = {
  proc __tostack64u8 (out:W8.t Array64.t, inp:W64.t) : W8.t Array64.t = {
    var aux: int;
    ...
    i <- 0;
    while (i < 64) {
      t <- (loadW8 Glob.mem (W64.to_uint (inp + (W64.of_int i))));
      out.[i] <- t;
      i <- i + 1;
    }
    return (out);
  ...
  proc __tostack96u8 (out:W8.t Array96.t, inp:W64.t) : W8.t Array96.t = {
    var aux: int;
  ...
  proc __store4 (p:W64.t, a:W64.t Array4.t) : unit = {
    ...
    while (i < 4) {
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (p + (W64.of_int (8 * i)))) (a.[i]);
      i <- i + 1;
    }
    return ();
  }
  ...
  proc __tobytes4 (f:W64.t Array4.t) : W64.t Array4.t = {
    ...
    t <- LEA_64 (f.[3] + f.[3]);
    (aux_3, aux_2, aux_1, aux_0, aux, aux_4) <- SAR_64 f.[3] (W8.of_int 63);
    _of_ <- aux_3;
    _cf_ <- aux_2;
    _sf_ <- aux_1;
     _0 <- aux_0;
  ...
  proc __montgomery_ladder4 (u:W64.t Array4.t, k:W8.t Array32.t) : W64.t Array4.t *
    ...
    (x2, z2r, x3, z3, swapped) <@ __montgomery_ladder_step4 (k, us, x2, z2r,
    x3, z3, swapped, ctr);
  ...
  proc xwing_x25519_base_p_rp (qp:W64.t, _n:W8.t Array32.t) : unit = {
    var aux: int;
  ...
  proc xwing_x25519_rp_rp_p (_q:W8.t Array32.t, _n:W8.t Array32.t, pp:W64.t) : 
  W8.t Array32.t = {
    var aux: int;
    ...
    i <- 0;
    while (i < 4) {
      p.[i] <- (loadW64 Glob.mem (W64.to_uint (pp + (W64.of_int (8 * i)))));
      i <- i + 1;
    }
    ...
    while (i < 4) {
      _q <-
      Array32.init
      (WArray32.get8 (WArray32.set64 (WArray32.init8 (fun i_0 => (_q).[i_0])) i (
      q.[i])));
      i <- i + 1;
    }
    return (_q);
  ...
  proc xwing_x25519_rp_p_p (_q:W8.t Array32.t, np:W64.t, pp:W64.t) : 
  W8.t Array32.t = {
    var aux: int;
    ...
    i <- 0;
    while (i < 4) {
      n.[i] <- (loadW64 Glob.mem (W64.to_uint (np + (W64.of_int (8 * i)))));
      i <- i + 1;
    }
    i <- 0;
    while (i < 4) {
  ...
  proc _xwing_sha3 (k:W64.t, k1:W64.t, k2:W8.t Array32.t, c2:W64.t, pk2:W64.t) : unit = {
    var aux: int;
    ...
    while (i < 4) {
      state <-
      Array25.init
      (WArray200.get64 (WArray200.set64_direct (WArray200.init64 (fun i_0 => (state).[i_0])) ((6 + 0) + (i * 8)) ((loadW64 Glob.mem (W64.to_uint (k1 + (W64.of_int (i * 8))))))));
      state <-
      Array25.init
      (WArray200.get64 (WArray200.set64_direct (WArray200.init64 (fun i_0 => (state).[i_0])) ((6 + 32) + (i * 8)) (
      (get64 (WArray32.init8 (fun i_0 => (k2).[i_0])) i))));
      state <-
      Array25.init
      (WArray200.get64 (WArray200.set64_direct (WArray200.init64 (fun i_0 => (state).[i_0])) ((6 + 64) + (i * 8)) ((loadW64 Glob.mem (W64.to_uint (c2 + (W64.of_int (i * 8))))))));
      state <-
      Array25.init
      (WArray200.get64 (WArray200.set64_direct (WArray200.init64 (fun i_0 => (state).[i_0])) ((6 + 96) + (i * 8)) ((loadW64 Glob.mem (W64.to_uint (pk2 + (W64.of_int (i * 8))))))));
      i <- i + 1;
    }
    state <-
    Array25.init
    (WArray200.get64 (WArray200.set16_direct (WArray200.init64 (fun i_0 => (state).[i_0])) 134 ((W16.of_int 0))));
    i <- 17;
    while (i < 25) {
      state.[i] <- (W64.of_int 0);
      i <- i + 1;
    ...
    state <-
    Array25.init
    (WArray200.get64 (WArray200.set8 (WArray200.init64 (fun i_0 => (state).[i_0])) 134 ((
    (get8 (WArray200.init64 (fun i_0 => (state).[i_0])) 134) `^` (W8.of_int 6)))));
    state <-
    Array25.init
    ...
    while (i < 4) {
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (k + (W64.of_int (8 * i)))) (state.[i]);
      i <- i + 1;
    }
    return ();
  }
  
  proc _crypto_xkem_keypair_derand_jazz (pkp:W64.t, skp:W64.t,
                                         randomness:W8.t Array96.t) : unit = {
    var aux: int;
    
    var pk2:W64.t;
    var sk2:W8.t Array32.t;
    var i:int;
    var  _0:W64.t;
    var  _1:W64.t;
    sk2 <- witness;
    ...
    (Array64.init (fun i_0 => randomness.[0 + i_0])));
    (* Erased call to unspill *)
     _0 <- init_msf ;
    pk2 <- LEA_64 (pkp + (W64.of_int ((3 * 384) + 32)));
    xwing_x25519_base_p_rp (pk2,
    (Array32.init (fun i_0 => randomness.[(32 * 2) + i_0])));
    (* Erased call to unspill *)
     _1 <- init_msf ;
    sk2 <- (Array32.init (fun i_0 => randomness.[(32 * 2) + i_0]));
    pk2 <- LEA_64 (pkp + (W64.of_int ((3 * 384) + 32)));
    i <- 0;
    while (i < 4) {
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (skp + (W64.of_int ((((3 * 384) + ((3 * 384) + 32)) + (2 * 32)) + (i * 8))))) (
      (get64 (WArray32.init8 (fun i_0 => (sk2).[i_0])) i));
      Glob.mem <-
      storeW64 Glob.mem (W64.to_uint (skp + (W64.of_int (((((3 * 384) + ((3 * 384) + 32)) + (2 * 32)) + 32) + (i * 8))))) ((loadW64 Glob.mem (W64.to_uint (pk2 + (W64.of_int (i * 8))))));
      i <- i + 1;
    }
    return ();
  }
  
  proc _crypto_xkem_enc_derand_jazz (ctp:W64.t, shkp:W64.t, pkp:W64.t,
                                     randomness:W8.t Array64.t) : unit = {
    
    var c2:W64.t;
    var ske:W8.t Array32.t;
    var pk2:W64.t;
    var k2:W8.t Array32.t;
    var k:W64.t;
    var k1:W64.t;
    var  _0:W64.t;
    var  _1:W64.t;
    ...
    (Array32.init (fun i => randomness.[0 + i])));
    (* Erased call to unspill *)
     _0 <- init_msf ;
    c2 <- LEA_64 (ctp + (W64.of_int ((3 * 320) + 128)));
    ske <- (Array32.init (fun i => randomness.[32 + i]));
  ...
  proc _crypto_xkem_dec_jazz (shkp:W64.t, ctp:W64.t, skp:W64.t) : unit = {
    ...
    (* Erased call to unspill *)
     _0 <- init_msf ;
    sk2 <-
    LEA_64 (skp + (W64.of_int (((3 * 384) + ((3 * 384) + 32)) + (2 * 32))));
    c2 <- LEA_64 (ctp + (W64.of_int ((3 * 320) + 128)));
    ...
    c2 <- LEA_64 (ctp + (W64.of_int ((3 * 320) + 128)));
    pk2 <-
    LEA_64 ((skp + (W64.of_int (((3 * 384) + ((3 * 384) + 32)) + (2 * 32)))) + (W64.of_int 32));
    _xwing_sha3 (k, k1, k2, c2, pk2);
    return ();
  }
  
  proc jade_kem_xwing_amd64_avx2_keypair_derand (public_key:W64.t,
                                                 secret_key:W64.t,
                                                 coins:W64.t) : W64.t = {
    
    var r:W64.t;
    var stack_coins:W8.t Array96.t;
    var _of_:bool;
    var _cf_:bool;
    var _sf_:bool;
    var _zf_:bool;
  ...
  proc jade_kem_xwing_amd64_avx2_enc_derand (ciphertext:W64.t,
                                             shared_secret:W64.t,
                                             public_key:W64.t, coins:W64.t) : 
  W64.t = {
    
    var r:W64.t;
    var stack_coins:W8.t Array64.t;
    var _of_:bool;
    var _cf_:bool;
    var _sf_:bool;
    var _zf_:bool;
    ...
    _crypto_xkem_enc_derand_jazz (ciphertext, shared_secret, public_key,
    stack_coins);
    (_of_, _cf_, _sf_,  _1, _zf_, r) <- set0_64 ;
    return (r);
  }
  
  proc jade_kem_xwing_amd64_avx2_dec (shared_secret:W64.t, ciphertext:W64.t,
